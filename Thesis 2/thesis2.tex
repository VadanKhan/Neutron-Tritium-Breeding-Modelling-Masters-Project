...
model (SOBO-GPR) (Section \ref{sec:theory_ml}). The optimisation pipeline was developed using the Ax
framework \citep{olson2025ax}, leveraging BoTorch \citep{Balandatetal2019} and PyTorch
...
why total multiplication steadily decreases as $\zeta$ increases (Figure \ref{fig:res_mult_b}).
...
\citep{brown_endfb-viii0_2018}. This caused rear-weighted sepaarators to safely scatter fast
neutrons with fewer immediate parasitic losses (Figure \ref{fig:scatter_absorb}). This complex

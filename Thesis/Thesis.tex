...
\begin{figure}[htbp]
    ...
    of ion temperature (keV) for the D-T, D-D, and D-${}^{3}$He fuel cycles. The D-T reaction's
...
\begin{figure}[htbp]
    ...
    ${}^{6}$Li(n,$\alpha$)t and ${}^{7}$Li(n,$\alpha$t)n', as a function of incident neutron energy.
    The ${}^{6}$Li cross-section is dominant at low (thermal) energies, while the ${}^{7}$Li
...
\begin{figure}[htbp]
    ...
    \caption{Neutron cross-sections for the (n,2n) neutron multiplication reactions in Beryllium (${}^{9}$Be) and Lead (${}^{208}$Pb). Both are threshold reactions that require high-energy neutrons, such as those from the D-T fusion reaction (14.1 MeV), to effectively multiply the neutron population.}

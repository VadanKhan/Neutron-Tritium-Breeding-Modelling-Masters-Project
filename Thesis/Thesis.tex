...
development for neutronic simulations \cite{kalos_monte_2008}.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l D{.}{.}{2} D{.}{.}{2} c c}
        ...
        \midrule
        \ce{Li2O} & 66.66 & 2.10 & 1.43 \\
        \ce{Li4SiO4} & 44.44 & 2.40 & 1.42 \\
        \ce{Li2TiO3} & 33.33 & 3.43 & 1.40 \\
        \midrule % --- This is the dashed line ---
        \ce{Li8PbO6} & 53.33 & 4.28 & 1.44 \\
        \ce{Li8SiO6} & 53.33 & 2.20 & 1.44 \\
        \ce{Li8CoO6} & 53.33 & 2.47 & 1.43 \\
        \ce{Li8GeO6} & 53.33 & 2.64 & 1.43 \\
        \ce{Li8ZrO6} & 53.33 & 2.98 & 1.43 \\
        \ce{Li8SnO6} & 53.33 & 3.41 & 1.42 \\
        \ce{Li8CeO6} & 53.33 & 3.25 & 1.42 \\
        \ce{Li6MnO4} & 54.55 & 2.50 & 1.42 \\
        \ce{Li6CoO4} & 54.55 & 2.77 & 1.42 \\
        \ce{Li6ZnO4} & 54.55 & 2.86 & 1.41 \\
        \ce{Li6Zr2O7} & 40.00 & 3.56 & 1.41 \\
        \ce{Li5AlO4} & 50.00 & 2.25 & 1.41 \\
        \ce{Li5FeO4} & 50.00 & 2.64 & 1.41 \\
        \ce{Li4TiO4} & 44.44 & 2.57 & 1.40 \\
        \ce{Li4GeO4} & 44.44 & 3.16 & 1.38 \\
        \ce{Li2SiO3} & 33.3 & 2.53 & 1.37 \\
        \ce{Li2MnO2} & 40.00 & 3.90 & 1.35 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l l D{.}{.}{2} D{.}{.}{2} c c}
        ...
        \midrule
        Li & - & 100 & 0.51 & 1.37 \\
        Li-Pb & 17:83 & 17.00 & 11.00 & 1.43 \\
        \ce{LiF-BeF2} & 2:1 & 28.57 & 2.04 & 1.33 \\
        \ce{LiF-BeF2}* & 1:1 & 20.00 & 2.06 & 1.33 \\
        \midrule % --- This was the dashed line in your image ---
        LiF & - & 50.00 & 2.64 & 1.36 \\
        \ce{Li3N} & - & 75.00 & 1.30 & 1.34 \\
        \ce{LiF-PbF2} & 2:3 & 15.38 & 3.55 & 1.34 \\
        \ce{LiF-BeF2-NaF} & 1:1:1 & 14.29 & 2.15 & 1.29 \\
        \ce{LiF-NaF-KF} & 46.5:11.5:42 & 20.17 & 2.02 & 1.29 \\
        \ce{LiF-LiBr-NaBr} & 20:73:7 & 46.50 & 3.16 & 1.25 \\
        \ce{LiF-LiBr-NaF} & 14:79:7 & 45.69 & 3.20 & 1.22 \\
        \ce{LiF-LiI2} & 83.5:16.5 & 50.00 & 3.68 & 1.20 \\
        \ce{LiF-NaF-ZrF4} & 55:22:23 & 20.45 & 2.72 & 1.15 \\
        \ce{LiCl-BeCl2} & 1:1 & 20.00 & - & 1.14 \\
        \ce{LiCl-PbCl2} & 1:2 & 12.50 & 4.50 & 1.10 \\
        \ce{LiCl-KCl} & 7:3 & 35.00 & 1.60 & 1.07 \\
        \ce{LiCl-KCl}* & 52:48 & 26.00 & 1.60 & 1.02 \\
        \ce{LiCl-NaCl} & 72:28 & 36.00 & 1.60 & 1.02 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[htbp]
    ...
    \caption{Graph Showing Increasing TBR trend against \ce{^6Li} Enrichment. This shows a
    "diminishing return" profile, but saturates much later. The curve is still perceptibly rising
    even at higher percentages.}
...
\begin{figure}[htbp]
    \centering
    % You can adjust the width as needed for your document layout
    \includegraphics[width=0.7\textwidth]{figures/LL Lead Fraction.png}
    \caption{Graph Showing TBR trend against Lead Multiplier Concentration. This graph peaks at
    ~50\%, and then TBR drops quickly after ~75\%.}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/Coolant Fraction Updated.png}
        \caption{Graph of TBR trends againt Coolant fraction for \ce{He(g)}, \ce{N(g)} and
        \ce{H_2O(l)}. This is a fraction of coolant per volume in the fusion breeder blanket,
        homogenously spread throughout the blanket as an approximation of real coolant structures.
        \ce{He(g)} and \ce{N(g)} have very similar trends, as act similar to replacing breeding
        material with a vacuum. \ce{H_2O(l)} has an interesting trend, in which TBR seems to
        decrease at a much slower rate against coolant fraction. This indicates that having large
        volumes of water is not much of a concern (as it acts as a moderators for neutron flux).}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/Coolant Energy (with void).png}
        \caption{Graph of no. of neutrons against energy just before a TBR reaction. This graph
        confirms that water is indeed acting as a moderator and "trapping" the neutrons with its
        high scattering cross section. Water therefore can act favourably towards tritium breeding
        as it can reduce the mean free path the neutrons significantly, and once moderatored TBR
        reactions have much higher cross section. \ce{He(g)} and \ce{N(g)} still act as vacuums.}
        \label{fig:coolant_moderation}
    \end{subfigure}

    \caption{(a) Demonstrates the effect of having an increasing volume of coolant distributed
    throughout the breeder blankets. (b) confirms the moderating effect of the water coolant.}
    \label{fig:coolants}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    % You can adjust the width as needed for your document layout
    \includegraphics[width=0.7\textwidth]{figures/Triangularity TBR.png}
    \caption{Graph showing the how TBR is largely unaffected by the triangularity of the reactor.
    This is expected for a neutronics study, particularly given that we are assuming a constant
    neutron ring source, whereas triangularity is a parameter that is significant for plasma physics
    and density. }
...
\begin{figure}[htbp]
    \centering
    % You can adjust the width as needed for your document layout
    \includegraphics[width=0.7\textwidth]{figures/FW Thickness.png}
    \caption{Graph showing the decreasing trend of TBR against first wall thickness. There are
    significant neutronic benefits of picking a first wall with lower cross section, with Zirconium
    leading to the highest TBRs.}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        % You can adjust the width as needed for your document layout
        \includegraphics[width=\textwidth]{figures/Blanket Thickness Updated.png}
        \caption{Graph Showing Increasing TBR trend against Breeder Blanket Thickness. The benefits
        of adding thickness diminish almost completely after ~500mm. This indicates that the neutron
        flux is fully attenuated after the saturation thickness.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{This heatmap confirms the attenuation of the neutron flux after the saturation
        thickness, by indicating almost no TBR reactions after 600mm through the breeder blanket.
        The Low level of TBR reactions in the first wall is due to its Zirconium Composition, which
        has a highly endothermic TBR reaction with a very low cross section.}
        \label{fig:heatmap_slice}
    \end{subfigure}

    \caption{(a) Demonstrates the asymptotic trend of TBR against blanket thickness. (b) confirms
    neutron attentuation as the physical cause.}
